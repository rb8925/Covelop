...
function loadBundle(data) {
    return database8f6a747d.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database8f6a747d.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database8f6a747d.Query$1(_this, 
...
registerBundle(database8f6a747d.Firestore);
